...
import { loginV } from './../../actions/vendor_actions'
export class LoginV extends Component {
    state={
        email:"",
        password:"",
        errors:[]
    ...
    submitForm=(event)=>{
        ...
        if (this.isFormValid(this.state)){
            ...
            this.props.dispatch(loginV(datatoSubmit)).then(response=>{
